...
const getMessageStructure = (message, path) => {
...
const publishToTarget = async (target, message, subject, path = '') => {
    ...
    try {        
        ...
        const params = {
            Message: getMessageStructure(message, path),
...
const publishToTopic = async (target, message, subject, path = '') => {
